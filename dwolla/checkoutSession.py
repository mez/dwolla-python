'''
 ...
 | (_| |\ V  V / (_) | | | (_| |
  ...
  ---------------------------------------------------------------------
  checkoutSession implements basic shopping cart functionality, if you
  already have this handled and would like to just submit requests, please
  look at checkouts.py.
'''

from dwolla import rest

class checkoutSession(rest.r):
    def __init__(self):
        self.cart = False
